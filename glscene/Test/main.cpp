...
glutil::ViewScale g_viewScale = {0.5f, 30.0f, 0.3f, 0.05f, 0.5f, 0.125f, 90.0f/250.0f};
...
void BuildGraph(glscene::SceneGraph &graph)
{
	...
	const boost::string_ref vertexShader(
		"#version 330\n"
	...
	const boost::string_ref fragmentShader(
		"#version 330\n"
		"out vec4 outputColor;\n"
		"void main()\n"
		"{\n"
		"   outputColor = vec4(0.2f, 0.8f, 0.2f, 1.0f);\n"
		"}\n"
		);

	GLuint prog = glutil::LinkProgram(vertexShader, fragmentShader);
