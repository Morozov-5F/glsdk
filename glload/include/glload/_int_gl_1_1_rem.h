...
typedef void (CODEGEN_FUNCPTR * PFNGLVERTEX3FPROC)(GLfloat , GLfloat , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLVERTEX3FVPROC)(const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLVERTEX3IPROC)(GLint , GLint , GLint );
typedef void (CODEGEN_FUNCPTR * PFNGLVERTEX3IVPROC)(const GLint *);
typedef void (CODEGEN_FUNCPTR * PFNGLVERTEX3SPROC)(GLshort , GLshort , GLshort );
typedef void (CODEGEN_FUNCPTR * PFNGLVERTEX3SVPROC)(const GLshort *);
typedef void (CODEGEN_FUNCPTR * PFNGLVERTEX4DPROC)(GLdouble , GLdouble , GLdouble , GLdouble );
typedef void (CODEGEN_FUNCPTR * PFNGLVERTEX4DVPROC)(const GLdouble *);
typedef void (CODEGEN_FUNCPTR * PFNGLVERTEX4FPROC)(GLfloat , GLfloat , GLfloat , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLVERTEX4FVPROC)(const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLVERTEX4IPROC)(GLint , GLint , GLint , GLint );
typedef void (CODEGEN_FUNCPTR * PFNGLVERTEX4IVPROC)(const GLint *);
typedef void (CODEGEN_FUNCPTR * PFNGLVERTEX4SPROC)(GLshort , GLshort , GLshort , GLshort );
typedef void (CODEGEN_FUNCPTR * PFNGLVERTEX4SVPROC)(const GLshort *);
typedef void (CODEGEN_FUNCPTR * PFNGLCLIPPLANEPROC)(GLenum , const GLdouble *);
typedef void (CODEGEN_FUNCPTR * PFNGLCOLORMATERIALPROC)(GLenum , GLenum );
typedef void (CODEGEN_FUNCPTR * PFNGLFOGFPROC)(GLenum , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLFOGFVPROC)(GLenum , const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLFOGIPROC)(GLenum , GLint );
typedef void (CODEGEN_FUNCPTR * PFNGLFOGIVPROC)(GLenum , const GLint *);
typedef void (CODEGEN_FUNCPTR * PFNGLLIGHTFPROC)(GLenum , GLenum , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLLIGHTFVPROC)(GLenum , GLenum , const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLLIGHTIPROC)(GLenum , GLenum , GLint );
typedef void (CODEGEN_FUNCPTR * PFNGLLIGHTIVPROC)(GLenum , GLenum , const GLint *);
typedef void (CODEGEN_FUNCPTR * PFNGLLIGHTMODELFPROC)(GLenum , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLLIGHTMODELFVPROC)(GLenum , const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLLIGHTMODELIPROC)(GLenum , GLint );
typedef void (CODEGEN_FUNCPTR * PFNGLLIGHTMODELIVPROC)(GLenum , const GLint *);
typedef void (CODEGEN_FUNCPTR * PFNGLLINESTIPPLEPROC)(GLint , GLushort );
typedef void (CODEGEN_FUNCPTR * PFNGLMATERIALFPROC)(GLenum , GLenum , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLMATERIALFVPROC)(GLenum , GLenum , const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLMATERIALIPROC)(GLenum , GLenum , GLint );
typedef void (CODEGEN_FUNCPTR * PFNGLMATERIALIVPROC)(GLenum , GLenum , const GLint *);
typedef void (CODEGEN_FUNCPTR * PFNGLPOLYGONSTIPPLEPROC)(const GLubyte *);
typedef void (CODEGEN_FUNCPTR * PFNGLSHADEMODELPROC)(GLenum );
typedef void (CODEGEN_FUNCPTR * PFNGLTEXENVFPROC)(GLenum , GLenum , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLTEXENVFVPROC)(GLenum , GLenum , const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLTEXENVIPROC)(GLenum , GLenum , GLint );
typedef void (CODEGEN_FUNCPTR * PFNGLTEXENVIVPROC)(GLenum , GLenum , const GLint *);
typedef void (CODEGEN_FUNCPTR * PFNGLTEXGENDPROC)(GLenum , GLenum , GLdouble );
typedef void (CODEGEN_FUNCPTR * PFNGLTEXGENDVPROC)(GLenum , GLenum , const GLdouble *);
typedef void (CODEGEN_FUNCPTR * PFNGLTEXGENFPROC)(GLenum , GLenum , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLTEXGENFVPROC)(GLenum , GLenum , const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLTEXGENIPROC)(GLenum , GLenum , GLint );
typedef void (CODEGEN_FUNCPTR * PFNGLTEXGENIVPROC)(GLenum , GLenum , const GLint *);
typedef void (CODEGEN_FUNCPTR * PFNGLFEEDBACKBUFFERPROC)(GLsizei , GLenum , GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLSELECTBUFFERPROC)(GLsizei , GLuint *);
typedef GLint (CODEGEN_FUNCPTR * PFNGLRENDERMODEPROC)(GLenum );
typedef void (CODEGEN_FUNCPTR * PFNGLINITNAMESPROC)();
typedef void (CODEGEN_FUNCPTR * PFNGLLOADNAMEPROC)(GLuint );
typedef void (CODEGEN_FUNCPTR * PFNGLPASSTHROUGHPROC)(GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLPOPNAMEPROC)();
typedef void (CODEGEN_FUNCPTR * PFNGLPUSHNAMEPROC)(GLuint );
typedef void (CODEGEN_FUNCPTR * PFNGLCLEARACCUMPROC)(GLfloat , GLfloat , GLfloat , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLCLEARINDEXPROC)(GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLINDEXMASKPROC)(GLuint );
typedef void (CODEGEN_FUNCPTR * PFNGLACCUMPROC)(GLenum , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLPOPATTRIBPROC)();
typedef void (CODEGEN_FUNCPTR * PFNGLPUSHATTRIBPROC)(GLbitfield );
typedef void (CODEGEN_FUNCPTR * PFNGLMAP1DPROC)(GLenum , GLdouble , GLdouble , GLint , GLint , const GLdouble *);
typedef void (CODEGEN_FUNCPTR * PFNGLMAP1FPROC)(GLenum , GLfloat , GLfloat , GLint , GLint , const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLMAP2DPROC)(GLenum , GLdouble , GLdouble , GLint , GLint , GLdouble , GLdouble , GLint , GLint , const GLdouble *);
typedef void (CODEGEN_FUNCPTR * PFNGLMAP2FPROC)(GLenum , GLfloat , GLfloat , GLint , GLint , GLfloat , GLfloat , GLint , GLint , const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLMAPGRID1DPROC)(GLint , GLdouble , GLdouble );
typedef void (CODEGEN_FUNCPTR * PFNGLMAPGRID1FPROC)(GLint , GLfloat , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLMAPGRID2DPROC)(GLint , GLdouble , GLdouble , GLint , GLdouble , GLdouble );
typedef void (CODEGEN_FUNCPTR * PFNGLMAPGRID2FPROC)(GLint , GLfloat , GLfloat , GLint , GLfloat , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLEVALCOORD1DPROC)(GLdouble );
typedef void (CODEGEN_FUNCPTR * PFNGLEVALCOORD1DVPROC)(const GLdouble *);
typedef void (CODEGEN_FUNCPTR * PFNGLEVALCOORD1FPROC)(GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLEVALCOORD1FVPROC)(const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLEVALCOORD2DPROC)(GLdouble , GLdouble );
typedef void (CODEGEN_FUNCPTR * PFNGLEVALCOORD2DVPROC)(const GLdouble *);
typedef void (CODEGEN_FUNCPTR * PFNGLEVALCOORD2FPROC)(GLfloat , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLEVALCOORD2FVPROC)(const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLEVALMESH1PROC)(GLenum , GLint , GLint );
typedef void (CODEGEN_FUNCPTR * PFNGLEVALPOINT1PROC)(GLint );
typedef void (CODEGEN_FUNCPTR * PFNGLEVALMESH2PROC)(GLenum , GLint , GLint , GLint , GLint );
typedef void (CODEGEN_FUNCPTR * PFNGLEVALPOINT2PROC)(GLint , GLint );
typedef void (CODEGEN_FUNCPTR * PFNGLALPHAFUNCPROC)(GLenum , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLPIXELZOOMPROC)(GLfloat , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLPIXELTRANSFERFPROC)(GLenum , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLPIXELTRANSFERIPROC)(GLenum , GLint );
typedef void (CODEGEN_FUNCPTR * PFNGLPIXELMAPFVPROC)(GLenum , GLsizei , const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLPIXELMAPUIVPROC)(GLenum , GLsizei , const GLuint *);
typedef void (CODEGEN_FUNCPTR * PFNGLPIXELMAPUSVPROC)(GLenum , GLsizei , const GLushort *);
typedef void (CODEGEN_FUNCPTR * PFNGLCOPYPIXELSPROC)(GLint , GLint , GLsizei , GLsizei , GLenum );
typedef void (CODEGEN_FUNCPTR * PFNGLDRAWPIXELSPROC)(GLsizei , GLsizei , GLenum , GLenum , const GLvoid *);
typedef void (CODEGEN_FUNCPTR * PFNGLGETCLIPPLANEPROC)(GLenum , GLdouble *);
typedef void (CODEGEN_FUNCPTR * PFNGLGETLIGHTFVPROC)(GLenum , GLenum , GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLGETLIGHTIVPROC)(GLenum , GLenum , GLint *);
typedef void (CODEGEN_FUNCPTR * PFNGLGETMAPDVPROC)(GLenum , GLenum , GLdouble *);
typedef void (CODEGEN_FUNCPTR * PFNGLGETMAPFVPROC)(GLenum , GLenum , GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLGETMAPIVPROC)(GLenum , GLenum , GLint *);
typedef void (CODEGEN_FUNCPTR * PFNGLGETMATERIALFVPROC)(GLenum , GLenum , GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLGETMATERIALIVPROC)(GLenum , GLenum , GLint *);
typedef void (CODEGEN_FUNCPTR * PFNGLGETPIXELMAPFVPROC)(GLenum , GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLGETPIXELMAPUIVPROC)(GLenum , GLuint *);
typedef void (CODEGEN_FUNCPTR * PFNGLGETPIXELMAPUSVPROC)(GLenum , GLushort *);
typedef void (CODEGEN_FUNCPTR * PFNGLGETPOLYGONSTIPPLEPROC)(GLubyte *);
typedef void (CODEGEN_FUNCPTR * PFNGLGETTEXENVFVPROC)(GLenum , GLenum , GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLGETTEXENVIVPROC)(GLenum , GLenum , GLint *);
typedef void (CODEGEN_FUNCPTR * PFNGLGETTEXGENDVPROC)(GLenum , GLenum , GLdouble *);
typedef void (CODEGEN_FUNCPTR * PFNGLGETTEXGENFVPROC)(GLenum , GLenum , GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLGETTEXGENIVPROC)(GLenum , GLenum , GLint *);
typedef GLboolean (CODEGEN_FUNCPTR * PFNGLISLISTPROC)(GLuint );
typedef void (CODEGEN_FUNCPTR * PFNGLFRUSTUMPROC)(GLdouble , GLdouble , GLdouble , GLdouble , GLdouble , GLdouble );
typedef void (CODEGEN_FUNCPTR * PFNGLLOADIDENTITYPROC)();
typedef void (CODEGEN_FUNCPTR * PFNGLLOADMATRIXFPROC)(const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLLOADMATRIXDPROC)(const GLdouble *);
typedef void (CODEGEN_FUNCPTR * PFNGLMATRIXMODEPROC)(GLenum );
typedef void (CODEGEN_FUNCPTR * PFNGLMULTMATRIXFPROC)(const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLMULTMATRIXDPROC)(const GLdouble *);
typedef void (CODEGEN_FUNCPTR * PFNGLORTHOPROC)(GLdouble , GLdouble , GLdouble , GLdouble , GLdouble , GLdouble );
typedef void (CODEGEN_FUNCPTR * PFNGLPOPMATRIXPROC)();
typedef void (CODEGEN_FUNCPTR * PFNGLPUSHMATRIXPROC)();
typedef void (CODEGEN_FUNCPTR * PFNGLROTATEDPROC)(GLdouble , GLdouble , GLdouble , GLdouble );
typedef void (CODEGEN_FUNCPTR * PFNGLROTATEFPROC)(GLfloat , GLfloat , GLfloat , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLSCALEDPROC)(GLdouble , GLdouble , GLdouble );
typedef void (CODEGEN_FUNCPTR * PFNGLSCALEFPROC)(GLfloat , GLfloat , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLTRANSLATEDPROC)(GLdouble , GLdouble , GLdouble );
typedef void (CODEGEN_FUNCPTR * PFNGLTRANSLATEFPROC)(GLfloat , GLfloat , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLARRAYELEMENTPROC)(GLint );
typedef void (CODEGEN_FUNCPTR * PFNGLCOLORPOINTERPROC)(GLint , GLenum , GLsizei , const GLvoid *);
typedef void (CODEGEN_FUNCPTR * PFNGLDISABLECLIENTSTATEPROC)(GLenum );
typedef void (CODEGEN_FUNCPTR * PFNGLEDGEFLAGPOINTERPROC)(GLsizei , const GLvoid *);
typedef void (CODEGEN_FUNCPTR * PFNGLENABLECLIENTSTATEPROC)(GLenum );
typedef void (CODEGEN_FUNCPTR * PFNGLINDEXPOINTERPROC)(GLenum , GLsizei , const GLvoid *);
typedef void (CODEGEN_FUNCPTR * PFNGLINTERLEAVEDARRAYSPROC)(GLenum , GLsizei , const GLvoid *);
typedef void (CODEGEN_FUNCPTR * PFNGLNORMALPOINTERPROC)(GLenum , GLsizei , const GLvoid *);
typedef void (CODEGEN_FUNCPTR * PFNGLTEXCOORDPOINTERPROC)(GLint , GLenum , GLsizei , const GLvoid *);
typedef void (CODEGEN_FUNCPTR * PFNGLVERTEXPOINTERPROC)(GLint , GLenum , GLsizei , const GLvoid *);
typedef GLboolean (CODEGEN_FUNCPTR * PFNGLARETEXTURESRESIDENTPROC)(GLsizei , const GLuint *, GLboolean *);
typedef void (CODEGEN_FUNCPTR * PFNGLPRIORITIZETEXTURESPROC)(GLsizei , const GLuint *, const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLPOPCLIENTATTRIBPROC)();
typedef void (CODEGEN_FUNCPTR * PFNGLPUSHCLIENTATTRIBPROC)(GLbitfield );
