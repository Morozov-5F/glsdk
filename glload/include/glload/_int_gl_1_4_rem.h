...
typedef void (CODEGEN_FUNCPTR * PFNGLFOGCOORDFPROC)(GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLFOGCOORDFVPROC)(const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLFOGCOORDDPROC)(GLdouble );
typedef void (CODEGEN_FUNCPTR * PFNGLFOGCOORDDVPROC)(const GLdouble *);
typedef void (CODEGEN_FUNCPTR * PFNGLFOGCOORDPOINTERPROC)(GLenum , GLsizei , const GLvoid *);
typedef void (CODEGEN_FUNCPTR * PFNGLSECONDARYCOLOR3BPROC)(GLbyte , GLbyte , GLbyte );
typedef void (CODEGEN_FUNCPTR * PFNGLSECONDARYCOLOR3BVPROC)(const GLbyte *);
typedef void (CODEGEN_FUNCPTR * PFNGLSECONDARYCOLOR3DPROC)(GLdouble , GLdouble , GLdouble );
typedef void (CODEGEN_FUNCPTR * PFNGLSECONDARYCOLOR3DVPROC)(const GLdouble *);
typedef void (CODEGEN_FUNCPTR * PFNGLSECONDARYCOLOR3FPROC)(GLfloat , GLfloat , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLSECONDARYCOLOR3FVPROC)(const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLSECONDARYCOLOR3IPROC)(GLint , GLint , GLint );
typedef void (CODEGEN_FUNCPTR * PFNGLSECONDARYCOLOR3IVPROC)(const GLint *);
typedef void (CODEGEN_FUNCPTR * PFNGLSECONDARYCOLOR3SPROC)(GLshort , GLshort , GLshort );
typedef void (CODEGEN_FUNCPTR * PFNGLSECONDARYCOLOR3SVPROC)(const GLshort *);
typedef void (CODEGEN_FUNCPTR * PFNGLSECONDARYCOLOR3UBPROC)(GLubyte , GLubyte , GLubyte );
typedef void (CODEGEN_FUNCPTR * PFNGLSECONDARYCOLOR3UBVPROC)(const GLubyte *);
typedef void (CODEGEN_FUNCPTR * PFNGLSECONDARYCOLOR3UIPROC)(GLuint , GLuint , GLuint );
typedef void (CODEGEN_FUNCPTR * PFNGLSECONDARYCOLOR3UIVPROC)(const GLuint *);
typedef void (CODEGEN_FUNCPTR * PFNGLSECONDARYCOLOR3USPROC)(GLushort , GLushort , GLushort );
typedef void (CODEGEN_FUNCPTR * PFNGLSECONDARYCOLOR3USVPROC)(const GLushort *);
typedef void (CODEGEN_FUNCPTR * PFNGLSECONDARYCOLORPOINTERPROC)(GLint , GLenum , GLsizei , const GLvoid *);
typedef void (CODEGEN_FUNCPTR * PFNGLWINDOWPOS2DPROC)(GLdouble , GLdouble );
typedef void (CODEGEN_FUNCPTR * PFNGLWINDOWPOS2DVPROC)(const GLdouble *);
typedef void (CODEGEN_FUNCPTR * PFNGLWINDOWPOS2FPROC)(GLfloat , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLWINDOWPOS2FVPROC)(const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLWINDOWPOS2IPROC)(GLint , GLint );
typedef void (CODEGEN_FUNCPTR * PFNGLWINDOWPOS2IVPROC)(const GLint *);
typedef void (CODEGEN_FUNCPTR * PFNGLWINDOWPOS2SPROC)(GLshort , GLshort );
typedef void (CODEGEN_FUNCPTR * PFNGLWINDOWPOS2SVPROC)(const GLshort *);
typedef void (CODEGEN_FUNCPTR * PFNGLWINDOWPOS3DPROC)(GLdouble , GLdouble , GLdouble );
typedef void (CODEGEN_FUNCPTR * PFNGLWINDOWPOS3DVPROC)(const GLdouble *);
typedef void (CODEGEN_FUNCPTR * PFNGLWINDOWPOS3FPROC)(GLfloat , GLfloat , GLfloat );
typedef void (CODEGEN_FUNCPTR * PFNGLWINDOWPOS3FVPROC)(const GLfloat *);
typedef void (CODEGEN_FUNCPTR * PFNGLWINDOWPOS3IPROC)(GLint , GLint , GLint );
typedef void (CODEGEN_FUNCPTR * PFNGLWINDOWPOS3IVPROC)(const GLint *);
typedef void (CODEGEN_FUNCPTR * PFNGLWINDOWPOS3SPROC)(GLshort , GLshort , GLshort );
typedef void (CODEGEN_FUNCPTR * PFNGLWINDOWPOS3SVPROC)(const GLshort *);
