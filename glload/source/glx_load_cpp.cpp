...
extern glX::_detail::Proc_glXAssociateDMPbufferSGIX _funcptr_glXAssociateDMPbufferSGIX;
...
extern glX::_detail::Proc_glXBindHyperpipeSGIX _funcptr_glXBindHyperpipeSGIX;
extern glX::_detail::Proc_glXDestroyHyperpipeConfigSGIX _funcptr_glXDestroyHyperpipeConfigSGIX;
extern glX::_detail::Proc_glXHyperpipeAttribSGIX _funcptr_glXHyperpipeAttribSGIX;
extern glX::_detail::Proc_glXHyperpipeConfigSGIX _funcptr_glXHyperpipeConfigSGIX;
extern glX::_detail::Proc_glXQueryHyperpipeAttribSGIX _funcptr_glXQueryHyperpipeAttribSGIX;
extern glX::_detail::Proc_glXQueryHyperpipeBestAttribSGIX _funcptr_glXQueryHyperpipeBestAttribSGIX;
extern glX::_detail::Proc_glXQueryHyperpipeConfigSGIX _funcptr_glXQueryHyperpipeConfigSGIX;
extern glX::_detail::Proc_glXQueryHyperpipeNetworkSGIX _funcptr_glXQueryHyperpipeNetworkSGIX;
...
extern glX::_detail::Proc_glXCreateGLXVideoSourceSGIX _funcptr_glXCreateGLXVideoSourceSGIX;
extern glX::_detail::Proc_glXDestroyGLXVideoSourceSGIX _funcptr_glXDestroyGLXVideoSourceSGIX;
...
namespace glX
{
	namespace exts
	{
		...
		glload::LoadTest var_SGIX_dmbuffer;
		glload::LoadTest var_SGIX_fbconfig;
		glload::LoadTest var_SGIX_hyperpipe;
		...
		glload::LoadTest var_SGIX_video_source;
	...
	_detail::Proc_glXAssociateDMPbufferSGIX AssociateDMPbufferSGIX = 0;
	...
	_detail::Proc_glXBindHyperpipeSGIX BindHyperpipeSGIX = 0;
	_detail::Proc_glXDestroyHyperpipeConfigSGIX DestroyHyperpipeConfigSGIX = 0;
	_detail::Proc_glXHyperpipeAttribSGIX HyperpipeAttribSGIX = 0;
	_detail::Proc_glXHyperpipeConfigSGIX HyperpipeConfigSGIX = 0;
	_detail::Proc_glXQueryHyperpipeAttribSGIX QueryHyperpipeAttribSGIX = 0;
	_detail::Proc_glXQueryHyperpipeBestAttribSGIX QueryHyperpipeBestAttribSGIX = 0;
	_detail::Proc_glXQueryHyperpipeConfigSGIX QueryHyperpipeConfigSGIX = 0;
	_detail::Proc_glXQueryHyperpipeNetworkSGIX QueryHyperpipeNetworkSGIX = 0;
	...
	_detail::Proc_glXCreateGLXVideoSourceSGIX CreateGLXVideoSourceSGIX = 0;
	_detail::Proc_glXDestroyGLXVideoSourceSGIX DestroyGLXVideoSourceSGIX = 0;
	...
	static void CopyExtensionVariables()
	{
		...
		exts::var_SGIX_dmbuffer = glload::LoadTest((::glXext_SGIX_dmbuffer != 0), ::glXext_SGIX_dmbuffer - 1);
		exts::var_SGIX_fbconfig = glload::LoadTest((::glXext_SGIX_fbconfig != 0), ::glXext_SGIX_fbconfig - 1);
		exts::var_SGIX_hyperpipe = glload::LoadTest((::glXext_SGIX_hyperpipe != 0), ::glXext_SGIX_hyperpipe - 1);
		...
		exts::var_SGIX_video_source = glload::LoadTest((::glXext_SGIX_video_source != 0), ::glXext_SGIX_video_source - 1);
	...
	static void CopyFunctionPointers()
	{
		...
		AssociateDMPbufferSGIX = _funcptr_glXAssociateDMPbufferSGIX;
		...
		BindHyperpipeSGIX = _funcptr_glXBindHyperpipeSGIX;
		DestroyHyperpipeConfigSGIX = _funcptr_glXDestroyHyperpipeConfigSGIX;
		HyperpipeAttribSGIX = _funcptr_glXHyperpipeAttribSGIX;
		HyperpipeConfigSGIX = _funcptr_glXHyperpipeConfigSGIX;
		QueryHyperpipeAttribSGIX = _funcptr_glXQueryHyperpipeAttribSGIX;
		QueryHyperpipeBestAttribSGIX = _funcptr_glXQueryHyperpipeBestAttribSGIX;
		QueryHyperpipeConfigSGIX = _funcptr_glXQueryHyperpipeConfigSGIX;
		QueryHyperpipeNetworkSGIX = _funcptr_glXQueryHyperpipeNetworkSGIX;
		...
		CreateGLXVideoSourceSGIX = _funcptr_glXCreateGLXVideoSourceSGIX;
		DestroyGLXVideoSourceSGIX = _funcptr_glXDestroyGLXVideoSourceSGIX;
