...
namespace gl
{
	namespace exts
	{
		...
		glload::LoadTest var_FfdMaskSGIX;
		...
		glload::LoadTest var_SGIX_fog_scale;
		glload::LoadTest var_SGIX_fragment_lighting;
		glload::LoadTest var_SGIX_framezoom;
		glload::LoadTest var_SGIX_impact_pixel_texture;
		...
		glload::LoadTest var_SGI_depth_pass_instrument;
	...
	static void CopyExtensionVariables()
	{
		...
		exts::var_FfdMaskSGIX = glload::LoadTest((::glext_FfdMaskSGIX != 0), ::glext_FfdMaskSGIX - 1);
		...
		exts::var_SGIX_fog_scale = glload::LoadTest((::glext_SGIX_fog_scale != 0), ::glext_SGIX_fog_scale - 1);
		...
		exts::var_SGIX_impact_pixel_texture = glload::LoadTest((::glext_SGIX_impact_pixel_texture != 0), ::glext_SGIX_impact_pixel_texture - 1);
		...
		exts::var_SGI_depth_pass_instrument = glload::LoadTest((::glext_SGI_depth_pass_instrument != 0), ::glext_SGI_depth_pass_instrument - 1);
