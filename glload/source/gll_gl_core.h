...
typedef struct GLeStandardCoreStruct_s
{
	...
	void *gleVarGetActiveAtomicCounterBufferiv;
	...
	void *gleVarDrawTransformFeedbackInstanced;
	void *gleVarDrawTransformFeedbackStreamInstanced;
	...
	void *gleVarBindImageTexture;
	void *gleVarMemoryBarrier;
	void *gleVarTexStorage1D;
	void *gleVarTexStorage2D;
	void *gleVarTexStorage3D;
	void *gleVarTextureStorage1DEXT;
	void *gleVarTextureStorage2DEXT;
	void *gleVarTextureStorage3DEXT;
	...
	void *gleVarGetInternalformativ;
	...
	void *gleVarDrawArraysInstancedBaseInstance;
	void *gleVarDrawElementsInstancedBaseInstance;
	void *gleVarDrawElementsInstancedBaseVertexBaseInstance;
